...
const testimonial_data: DataType[] = [
  {
    ...
    des: `“Gyldan has been instrumental in enhancing our business's online presence through expert website design and development. Their tailored solutions have truly made a difference.”`,
  },
  {
    img: avatar_img,
    name: `Jerico Tay`,
    location: `From Singapore`,
    des: `“Thanks to Gyldan's corporate advisory services, we've streamlined our operations and achieved significant growth. Their expertise in business setup and compliance is unparalleled.”`,
  },
  {
    img: avatar_img,
    name: `Jared Lim`,
    location: `From Selangor`,
    des: `“Grandeurs Coliving by Gyldan has transformed our property investments, creating communities that resonate with both tenants and landlords alike. A truly exceptional management service.”`,
  },
];
