...
const innovative_data: DataType = {
  title_1: `Gyldan Properties: Your Commercial Property Partner`,
  des_1: `Specializing in Complex Shoplots, Warehouses, Lands, and Malls.`,
              ...
              <div className="cs_text">
                <div className="cs_section_heading cs_style_1">
                  <div className="cs_section_heading_text">
                    <h2 className="cs_section_title anim_heading_title">{title_1}</h2>
                  </div>
                </div>
...
export default PropertyHeadline;
